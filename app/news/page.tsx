    ...
    <main className="pt-20">
      <section className="bg-navy-dark py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <span className="text-silver text-xs font-semibold uppercase tracking-[0.2em] block mb-3">From Our Blog</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-silver-100">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Featured article */}
          {featured && (
            <article id={featured.slug} className="grid md:grid-cols-2 gap-0 mb-16 border border-silver/30 overflow-hidden">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center bg-white">
                <span className="text-silver text-xs font-semibold uppercase tracking-[0.2em] mb-4">{featured.date}</span>
                <h2 className="font-display italic text-3xl md:text-4xl text-navy mb-4 leading-snug">{featured.title}</h2>
                <p className="text-slate/55 leading-relaxed mb-6">{featured.excerpt}</p>
                <div className="text-slate/60 text-sm leading-relaxed whitespace-pre-line border-t border-silver/30 pt-6">{featured.content}</div>
              </div>
            </article>
          )}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rest.map(post => (
              <article key={post.slug} id={post.slug} className="border border-silver/30 overflow-hidden bg-white">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate/55 text-sm leading-relaxed mb-4">{post.excerpt}</p>
                  <div className="text-slate/50 text-sm leading-relaxed whitespace-pre-line border-t border-silver/30 pt-4">{post.content}</div>
                </div>
              </article>
            ))}
          </div>
