        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
            ...
            <div>
              ...
              <p className="text-slate/70 text-lg leading-relaxed mb-6">{service.description}</p>
            ...
            <div className="space-y-4">
              {service.images.map((img, i) => (
                <div key={i} className="relative overflow-hidden border border-silver/30">
          ...
          {/* Features + Use Cases */}
          <div className="grid md:grid-cols-2 gap-12 border-t border-silver/30 pt-16">
            {service.features && (
              <div>
                <h2 className="font-display italic text-3xl text-navy mb-6">What&apos;s included</h2>
                <ul className="space-y-3">
                  {service.features.map(f => (
                    <li key={f} className="flex items-start gap-3 text-slate/70">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {service.useCases.map(u => (
                    <span key={u} className="px-4 py-2 border border-silver/30 text-slate/70 text-sm bg-silver/20">
                      {u}
                    </span>
                  ))}
                </div>
