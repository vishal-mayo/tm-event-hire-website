...
export default function AboutPage() {
  return (
    <main className="pt-20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-silver-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-slate/70 text-lg leading-relaxed mb-5">
            ...
            <p className="text-slate/70 text-lg leading-relaxed mb-8">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-silver p-6 rounded-sm shadow-xl">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-silver/20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              <div key={stat.l} className="bg-silver-100 p-6 rounded-sm shadow-sm">
                <div className="font-display text-4xl font-bold text-silver mb-2">{stat.n}</div>
                <div className="text-slate/70 text-sm font-semibold uppercase tracking-wide">{stat.l}</div>
              </div>
            ))}
          </div>
        </div>
